package org.firstinspires.ftc.teamcode.Auto.SOLO_CLOSE_18.RED;
...
public class RedCloseMirroredPaths {
    ...
    public RedCloseMirroredPaths(Follower follower) {
        ...
        gate = follower.pathBuilder().addPath(
                        new BezierCurve(
                                new Pose(59.000, 84.098).mirror(),
                                new Pose(53.829, 60.720).mirror(),
                                new Pose(25.829, 65.207).mirror(),
                                new Pose(12.463, 58.220).mirror()
                        )
                ).setHeadingInterpolation(
                        HeadingInterpolator.piecewise(
                                new HeadingInterpolator.PiecewiseNode(
        ...
        gateReturn = follower.pathBuilder().addPath(
                        new BezierLine(
                                new Pose(13.463, 64.220).mirror(),

                                new Pose(56.366, 88.463).mirror()
                        )
                ).setHeadingInterpolation(
                        HeadingInterpolator.piecewise(
                                new HeadingInterpolator.PiecewiseNode(
