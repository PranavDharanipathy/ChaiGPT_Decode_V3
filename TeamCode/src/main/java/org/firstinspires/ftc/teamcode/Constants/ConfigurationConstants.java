...
public class ConfigurationConstants {
    ...
    public static List<Double> TURRET_KPS =          new ArrayList<>(List.of(0.000215,    0.0002,     0.0002,     0.00021,    0.00021,   0.00022,     0.0002,    0.00017,    0.00014,     0.00011,     0.0001,      0.0001,    0.0001,      0.0001,      0.00011,     0.0001,    0.0001,     0.0001,    0.0001,      0.0001,    0.00011,   0.00012,   0.000125,   0.000135,   0.00015));
    public static List<Double> TURRET_KDS =          new ArrayList<>(List.of( 0.0025,     0.0049,     0.0049,     0.0048,     0.0048,    0.0042,      0.004,     0.0035,     0.0035,      0.0017,       0.0017,     0.002,     0.002,       0.002,       0.0021,      0.002,     0.002,      0.002,     0.002,    0.003355,    0.003375,   0.00425,   0.0043,      0.0043,     0.0015));
