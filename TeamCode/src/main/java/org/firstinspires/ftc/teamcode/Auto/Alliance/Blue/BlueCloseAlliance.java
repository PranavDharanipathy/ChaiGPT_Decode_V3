...
public class BlueCloseAlliance extends NextFTCOpMode {
    ...
    private Command auto() {
        ...
        return new SequentialGroup(
                ...
                //SECOND RETURN
                driveShootPara(paths.secondReturn, 1),
                ...
                //FIRST RETURN
                driveShootPara(paths.firstReturn, 1),
                ...
                driveShootPara(paths.thirdReturn, 1),
    ...
    private Command driveShootPara(PathChain pathChain, double transferTime) {
        ...
        return new ParallelGroup(
                ...
                new SequentialGroup(
                        new Delay(0.01),
                        RobotNF.robot.shootBallsAtParametricEnd(transferTime, pathChain)
                )
        );
    }
